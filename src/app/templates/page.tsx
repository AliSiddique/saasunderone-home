  ...
  >
    ...
    {template.coming_soon ? (
        <div className="relative">
            <div className="absolute inset-0 bg-[url('${post.heroImage}')] bg-no-repeat bg-cover bg-center bg-blur-xl"></div>
            <div className="absolute inset-0 flex items-center justify-center text-white text-2xl font-semibold bg-black bg-opacity-75">Coming Soon</div>
        </div>
    ) : (
        <a
            href={template.link}
